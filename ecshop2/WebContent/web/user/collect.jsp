		...
		<div id="content">
			...
			<div id="mid" style="float: left; width: 62.7%">
				<form id="form1" name="form1" method="post">
					<div style="background-color: #FAFAD2; width: 100%; height: 25px;">我的收藏
					</div>
					<table width="100%" border="0" align="center">
						<tr>
							<td width="157" style="text-align: center">商品名称</td>
							<td width="109" style="text-align: center">价格</td>
							<td width="186" style="text-align: center">操作</td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
