	...
	<div id="container" style="width: 1349px">
		...
		<div id="content">
			...
			<div id="mid" style="float: left; width: 62.7%">
				<div style="background-color: #FAFAD2; width: 100%; height: 25px;">已拥有的红包</div>
				<div id="redPacker02">
					<table width="100%" border="0" align="center">
						<tr>
							<td><div class="redpacker">红包序号</div></td>
							<td><div class="redpacker">红包名称</div></td>
							<td><div class="redpacker">红包金额</div></td>
							<td><div class="redpacker">最小订单金额</div></td>
							<td><div class="redpacker">截止使用日期</div></td>
							<td><div class="redpacker">红包状态</div></td>
						</tr>
						<tr>
							<td><div class="redpacker">89757</div></td>
							<td><div class="redpacker">南鱼红包</div></td>
							<td><div class="redpacker">6666</div></td>
							<td><div class="redpacker">888888</div></td>
							<td><div class="redpacker">2016.01.01</div></td>
							<td><div class="redpacker">可用</div></td>
						</tr>
					</table>
				</div>
				<div style="background-color: #E0ECFF; width: 100%; height: 25px;">添加新的红包</div>
				<div id="redPacker04">
					<table width="100%" border="0" align="center">
						<tr>
							<td width="33%" style="text-align: right">红包序列号：</td>
							<td width="17%"><input type="text" name="textfield"
								id="textfield"></td>
							<td width="50%"><input type="button" name="button"
								id="button" value="添加一个红包"></td>
						</tr>
					</table>
				</div>
			</div>
