	...
	<div id="container" style="width: 1349px">
		...
		<div id="content">
			...
			<div id="mid" style="float: left; width: 62.7%">
				<div style="background-color: #FAFAD2; width: 100%; height: 25px;">推荐分成
				</div>
				<div id="recommend04">
					<table width="100%" border="0">
						<tr>
							<td><div class="recommend">等级</div></td>
							<td><div class="recommend">人数</div></td>
							<td><div class="recommend">积分分成百分比</div></td>
							<td><div class="recommend">现金分成百分比</div></td>
						</tr>
						<tr>
							<td><div class="recommend">1</div></td>
							<td><div class="recommend">0</div></td>
							<td><div class="recommend">60%</div></td>
							<td><div class="recommend">60%</div></td>
						</tr>
						<tr>
							<td><div class="recommend">2</div></td>
							<td><div class="recommend">0</div></td>
							<td><div class="recommend">30%</div></td>
							<td><div class="recommend">30%</div></td>
						</tr>
						<tr>
							<td><div class="recommend">3</div></td>
							<td><div class="recommend">0</div></td>
							<td><div class="recommend">7%</div></td>
							<td><div class="recommend">7%</div></td>
						</tr>
						<tr>
							<td><div class="recommend">4</div></td>
							<td><div class="recommend">0</div></td>
							<td><div class="recommend">3%</div></td>
							<td><div class="recommend">3%</div></td>
						</tr>
				...
				<div style="background-color: #FAFAD2; width: 880px; height: 30px;">已推荐信息
				</div>
				<div id="recommend06">
					<table width="100%" border="0">
						<tr>
							<td><div class="recommend">订单号</div></td>
							<td><div class="recommend">积分分成</div></td>
							<td><div class="recommend">现金分成</div></td>
							<td><div class="recommend">分成模式</div></td>
							<td><div class="recommend">分成状态</div></td>
						</tr>
						<tr>
							<td colspan="5"><div class="recommend">没有记录</div></td>
						</tr>
					</table>
				</div>
			</div>
