...
<body>
	...
	<h1>
		...
		<span class="action-span1">NANYUSHOP
				管理中心</span><span id="search_id" class="action-span1"> - 商品列表 </span>
		...
		<div class="list-div" id="listDiv">
			<table cellpadding="3" cellspacing="1">
				...
				<tr>
					...
					<td><span onclick="listTable.edit(this, 'edit_goods_sn', 32)">${e.productID }</span></td>
					<td align="right"><span
						onclick="listTable.edit(this, 'edit_goods_price', 32)">${e.price }
					</span></td>
					
					<c:if test="${e.productUp.equals('1')}">
					
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_on_sale', 32)" /></td>
					</c:if>
					<c:if test="${e.productUp.equals('-1')}">
					...
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_best', 32)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/no.gif"
						onclick="listTable.toggle(this, 'toggle_new', 32)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_hot', 32)" /></td>
					<td align="center"><span
						onclick="listTable.edit(this, 'edit_sort_order', 32)">100</span></td>
					<td align="right"><span
						onclick="listTable.edit(this, 'edit_goods_number', 32)">${e.store }</span></td>
					<td align="center"><a href="<%=request.getContextPath()%>/AdminProductServlet.do?method=remove&productID=${e.productID }&pageCurrent=${pro.currentPages }"
						target="mainFrame" title="移除"><img src="<%=request.getContextPath()%>/images/admin/icon_drop.gif"
				...
				<%-- <tr>
					...
					<td class="first-cell" style=""><span
						onclick="listTable.edit(this, 'edit_goods_name', 31)">三星GalaxyS6</span></td>
					<td><span onclick="listTable.edit(this, 'edit_goods_sn', 31)">NYS000031</span></td>
					<td align="right"><span
						onclick="listTable.edit(this, 'edit_goods_price', 31)">6088.00
					</span></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/no.gif"
						onclick="listTable.toggle(this, 'toggle_on_sale', 31)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/no.gif"
						onclick="listTable.toggle(this, 'toggle_best', 31)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/no.gif"
						onclick="listTable.toggle(this, 'toggle_new', 31)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/no.gif"
						onclick="listTable.toggle(this, 'toggle_hot', 31)" /></td>
					<td align="center"><span
						onclick="listTable.edit(this, 'edit_sort_order', 31)">100</span></td>
					<td align="right"><span
						onclick="listTable.edit(this, 'edit_goods_number', 31)">1</span></td>
					<td align="center"><a href="../goods.php?id=31"
						target="_blank" title="查看"><img src="<%=request.getContextPath()%>/images/admin/icon_view.gif"
							width="16" height="16" border="0" /></a> <a
						href="goods.php?act=edit&goods_id=31&extension_code=" title="编辑"><img
							src="<%=request.getContextPath()%>/images/admin/icon_edit.gif" width="16" height="16" border="0" /></a>
					</td>
				</tr>
				<tr>
					...
					<td class="first-cell" style=""><span
						onclick="listTable.edit(this, 'edit_goods_name', 24)">华为荣耀畅玩4C</span></td>
					<td><span onclick="listTable.edit(this, 'edit_goods_sn', 24)">NYS000024</span></td>
					<td align="right"><span
						onclick="listTable.edit(this, 'edit_goods_price', 24)">599.00
					</span></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_on_sale', 24)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_best', 24)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_new', 24)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_hot', 24)" /></td>
					<td align="center"><span
						onclick="listTable.edit(this, 'edit_sort_order', 24)">100</span></td>
					<td align="right"><span
						onclick="listTable.edit(this, 'edit_goods_number', 24)">100</span></td>
					<td align="center"><a href="../goods.php?id=24"
						target="_blank" title="查看"><img src="<%=request.getContextPath()%>/images/admin/icon_view.gif"
							width="16" height="16" border="0" /></a> <a
						href="goods.php?act=edit&goods_id=24&extension_code=" title="编辑"><img
							src="<%=request.getContextPath()%>/images/admin/icon_edit.gif" width="16" height="16" border="0" /></a>
					</td>
				</tr>
				<tr>
					...
					<td class="first-cell" style=""><span
						onclick="listTable.edit(this, 'edit_goods_name', 23)">联想乐檬K3 Note</span></td>
					<td><span onclick="listTable.edit(this, 'edit_goods_sn', 23)">NYS000023</span></td>
					<td align="right"><span
						onclick="listTable.edit(this, 'edit_goods_price', 23)">1000.00
					</span></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_on_sale', 23)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_best', 23)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_new', 23)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/no.gif"
						onclick="listTable.toggle(this, 'toggle_hot', 23)" /></td>
					<td align="center"><span
						onclick="listTable.edit(this, 'edit_sort_order', 23)">100</span></td>
					<td align="right"><span
						onclick="listTable.edit(this, 'edit_goods_number', 23)">8</span></td>
					<td align="center"><a href="../goods.php?id=23"
						target="_blank" title="查看"><img src="<%=request.getContextPath()%>/images/admin/icon_view.gif"
							width="16" height="16" border="0" /></a> <a
						href="goods.php?act=edit&goods_id=23&extension_code=" title="编辑"><img
							src="<%=request.getContextPath()%>/images/admin/icon_edit.gif" width="16" height="16" border="0" /></a>
					</td>
				</tr>
				<tr>
					...
					<td class="first-cell" style=""><span
						onclick="listTable.edit(this, 'edit_goods_name', 22)">佳明手表
						   </span></td>
					<td><span onclick="listTable.edit(this, 'edit_goods_sn', 22)">NYS000022</span></td>
					<td align="right"><span
						onclick="listTable.edit(this, 'edit_goods_price', 22)">1680.00
					</span></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_on_sale', 22)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_best', 22)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_new', 22)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/no.gif"
						onclick="listTable.toggle(this, 'toggle_hot', 22)" /></td>
					<td align="center"><span
						onclick="listTable.edit(this, 'edit_sort_order', 22)">100</span></td>
					<td align="right"><span
						onclick="listTable.edit(this, 'edit_goods_number', 22)">1</span></td>
					<td align="center"><a href="../goods.php?id=22"
						target="_blank" title="查看"><img src="<%=request.getContextPath()%>/images/admin/icon_view.gif"
							width="16" height="16" border="0" /></a> <a
						href="goods.php?act=edit&goods_id=22&extension_code=" title="编辑"><img
							src="<%=request.getContextPath()%>/images/admin/icon_edit.gif" width="16" height="16" border="0" /></a>
					</td>
				</tr>
				<tr>
					...
					<td class="first-cell" style=""><span
						onclick="listTable.edit(this, 'edit_goods_name', 21)">优者GT08
							</span></td>
					<td><span onclick="listTable.edit(this, 'edit_goods_sn', 21)">NYS000021</span></td>
					<td align="right"><span
						onclick="listTable.edit(this, 'edit_goods_price', 21)">449.00
					</span></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_on_sale', 21)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/no.gif"
						onclick="listTable.toggle(this, 'toggle_best', 21)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/no.gif"
						onclick="listTable.toggle(this, 'toggle_new', 21)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/no.gif"
						onclick="listTable.toggle(this, 'toggle_hot', 21)" /></td>
					<td align="center"><span
						onclick="listTable.edit(this, 'edit_sort_order', 21)">100</span></td>
					<td align="right"><span
						onclick="listTable.edit(this, 'edit_goods_number', 21)">40</span></td>
					<td align="center"><a href="../goods.php?id=21"
						target="_blank" title="查看"><img src="<%=request.getContextPath()%>/images/admin/icon_view.gif"
							width="16" height="16" border="0" /></a> <a
						href="goods.php?act=edit&goods_id=21&extension_code=" title="编辑"><img
							src="<%=request.getContextPath()%>/images/admin/icon_edit.gif" width="16" height="16" border="0" /></a>
					</td>
				</tr>
				<tr>
					...
					<td class="first-cell" style=""><span
						onclick="listTable.edit(this, 'edit_goods_name', 20)">郎技智能蓝牙手表手机</span></td>
					<td><span onclick="listTable.edit(this, 'edit_goods_sn', 20)">NYS000020</span></td>
					<td align="right"><span
						onclick="listTable.edit(this, 'edit_goods_price', 20)">308.00
					</span></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_on_sale', 20)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_best', 20)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_new', 20)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_hot', 20)" /></td>
					<td align="center"><span
						onclick="listTable.edit(this, 'edit_sort_order', 20)">100</span></td>
					<td align="right"><span
						onclick="listTable.edit(this, 'edit_goods_number', 20)">12</span></td>
					<td align="center"><a href="../goods.php?id=20"
						target="_blank" title="查看"><img src="<%=request.getContextPath()%>/images/admin/icon_view.gif"
							width="16" height="16" border="0" /></a> <a
						href="goods.php?act=edit&goods_id=20&extension_code=" title="编辑"><img
							src="<%=request.getContextPath()%>/images/admin/icon_edit.gif" width="16" height="16" border="0" /></a>
					</td>
				</tr>
				<tr>
					<td><input type="checkbox" name="checkboxes[]" value="19" />19</td>
					<td class="first-cell" style=""><span
						onclick="listTable.edit(this, 'edit_goods_name', 19)">Wtitech D8智能手表</span></td>
					<td><span onclick="listTable.edit(this, 'edit_goods_sn', 19)">NYS000019</span></td>
					<td align="right"><span
						onclick="listTable.edit(this, 'edit_goods_price', 19)">268.00
					</span></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_on_sale', 19)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_best', 19)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_new', 19)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_hot', 19)" /></td>
					<td align="center"><span
						onclick="listTable.edit(this, 'edit_sort_order', 19)">100</span></td>
					<td align="right"><span
						onclick="listTable.edit(this, 'edit_goods_number', 19)">12</span></td>
					<td align="center"><a href="../goods.php?id=19"
						target="_blank" title="查看"><img src="<%=request.getContextPath()%>/images/admin/icon_view.gif"
							width="16" height="16" border="0" /></a> <a
						href="goods.php?act=edit&goods_id=19&extension_code=" title="编辑"><img
							src="<%=request.getContextPath()%>/images/admin/icon_edit.gif" width="16" height="16" border="0" /></a>
					</td>
				</tr>
				<tr>
					...
					<td class="first-cell" style=""><span
						onclick="listTable.edit(this, 'edit_goods_name', 17)">得力3711超薄键鼠</span></td>
					<td><span onclick="listTable.edit(this, 'edit_goods_sn', 17)">NYS000017</span></td>
					<td align="right"><span
						onclick="listTable.edit(this, 'edit_goods_price', 17)">69.00
					</span></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_on_sale', 17)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_best', 17)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/no.gif"
						onclick="listTable.toggle(this, 'toggle_new', 17)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_hot', 17)" /></td>
					<td align="center"><span
						onclick="listTable.edit(this, 'edit_sort_order', 17)">100</span></td>
					<td align="right"><span
						onclick="listTable.edit(this, 'edit_goods_number', 17)">1</span></td>
					<td align="center"><a href="../goods.php?id=17"
						target="_blank" title="查看"><img src="<%=request.getContextPath()%>/images/admin/icon_view.gif"
							width="16" height="16" border="0" /></a> <a
						href="goods.php?act=edit&goods_id=17&extension_code=" title="编辑"><img
							src="<%=request.getContextPath()%>/images/admin/icon_edit.gif" width="16" height="16" border="0" /></a>
					</td>
				</tr>
				<tr>
					...
					<td class="first-cell" style=""><span
						onclick="listTable.edit(this, 'edit_goods_name', 16)">现代HY-MA75键鼠</span></td>
					<td><span onclick="listTable.edit(this, 'edit_goods_sn', 16)">NYS000016</span></td>
					<td align="right"><span
						onclick="listTable.edit(this, 'edit_goods_price', 16)">29.00
					</span></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/no.gif"
						onclick="listTable.toggle(this, 'toggle_on_sale', 16)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/no.gif"
						onclick="listTable.toggle(this, 'toggle_best', 16)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/no.gif"
						onclick="listTable.toggle(this, 'toggle_new', 16)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/no.gif"
						onclick="listTable.toggle(this, 'toggle_hot', 16)" /></td>
					<td align="center"><span
						onclick="listTable.edit(this, 'edit_sort_order', 16)">100</span></td>
					<td align="right"><span
						onclick="listTable.edit(this, 'edit_goods_number', 16)">0</span></td>
					<td align="center"><a href="../goods.php?id=16"
						target="_blank" title="查看"><img src="<%=request.getContextPath()%>/images/admin/icon_view.gif"
							width="16" height="16" border="0" /></a> <a
						href="goods.php?act=edit&goods_id=14&extension_code=" title="编辑"><img
							src="<%=request.getContextPath()%>/images/admin/icon_edit.gif" width="16" height="16" border="0" /></a>
					</td>
				</tr>
				<tr>
					...
					<td class="first-cell" style=""><span
						onclick="listTable.edit(this, 'edit_goods_name', 14)">炫光lol键鼠套装</span></td>
					<td><span onclick="listTable.edit(this, 'edit_goods_sn', 14)">NYS000014</span></td>
					<td align="right"><span
						onclick="listTable.edit(this, 'edit_goods_price', 14)">69.00
					</span></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_on_sale', 14)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/no.gif"
						onclick="listTable.toggle(this, 'toggle_best', 14)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/no.gif"
						onclick="listTable.toggle(this, 'toggle_new', 14)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_hot', 14)" /></td>
					<td align="center"><span
						onclick="listTable.edit(this, 'edit_sort_order', 14)">100</span></td>
					<td align="right"><span
						onclick="listTable.edit(this, 'edit_goods_number', 14)">1</span></td>
					<td align="center"><a href="../goods.php?id=14"
						target="_blank" title="查看"><img src="<%=request.getContextPath()%>/images/admin/icon_view.gif"
							width="16" height="16" border="0" /></a> <a
						href="goods.php?act=edit&goods_id=14&extension_code=" title="编辑"><img
							src="<%=request.getContextPath()%>/images/admin/icon_edit.gif" width="16" height="16" border="0" /></a>
				...
				<tr>
					...
					<td class="first-cell" style=""><span
						onclick="listTable.edit(this, 'edit_goods_name', 13)">Microsoft/微软灵巧键鼠套装
							</span></td>
					<td><span onclick="listTable.edit(this, 'edit_goods_sn', 13)">NYS000013</span></td>
					<td align="right"><span
						onclick="listTable.edit(this, 'edit_goods_price', 13)">99.00
					</span></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_on_sale', 13)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/no.gif"
						onclick="listTable.toggle(this, 'toggle_best', 13)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/no.gif"
						onclick="listTable.toggle(this, 'toggle_new', 13)" /></td>
					<td align="center"><img src="<%=request.getContextPath()%>/images/admin/yes.gif"
						onclick="listTable.toggle(this, 'toggle_hot', 13)" /></td>
					<td align="center"><span
						onclick="listTable.edit(this, 'edit_sort_order', 13)">100</span></td>
					<td align="right"><span
						onclick="listTable.edit(this, 'edit_goods_number', 13)">8</span></td>
					<td align="center"><a href="../goods.php?id=13"
						target="_blank" title="查看"><img src="<%=request.getContextPath()%>/images/admin/icon_view.gif"
							width="16" height="16" border="0" /></a> <a
						href="goods.php?act=edit&goods_id=13&extension_code=" title="编辑"><img
							src="<%=request.getContextPath()%>/images/admin/icon_edit.gif" width="16" height="16" border="0" /></a>
					</td>
				</tr> --%>
			<!--  	
					...
					<td align="right" nowrap="true">
						...
						<div id="turn-page">
							...
							页当前第 <span id="pageCurrent" name="pageCurrent">${pro.currentPages }</span> 页，每页 <input type='text'
								...
								id="page-link"> 
								<a
								href="<%=request.getContextPath()%>/AdminProductServlet.do?method=search&pageCurrent=1" target="mainFrame">第一页</a> 
								<c:choose>
								<c:when test="${pro.currentPages==1 }">上一页</c:when>
								<c:otherwise>
								<a
								href="<%=request.getContextPath()%>/AdminProductServlet.do?method=search&pageCurrent=${pro.currentPages-1 }" target="mainFrame"">上一页</a>
			                    </c:otherwise>
			                    </c:choose>
			                    <c:choose>
								 ...
								 <c:otherwise>
								 <a
								href="<%=request.getContextPath()%>/AdminProductServlet.do?method=search&pageCurrent=${pro.currentPages+1 }" target="mainFrame">下一页</a>
								</c:otherwise>
								</c:choose>
								 <a
								href="<%=request.getContextPath()%>/AdminProductServlet.do?method=search&pageCurrent=${pro.totalPages}" target="mainFrame"">最末页</a> <select
