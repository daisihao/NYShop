...
<body>
<table width="800" height="32" border="0" bordercolor="#F7FFFF">
  <tr>
    <td width="800"><a href="index.php?act=main">南鱼商城 管理中心</a> <span id="search_id">- 退货单操作：查看 </span></td>
  </tr>
</table>
<table width="800" border="0" bordercolor="#F7FFFF">
  ...
  <tr bgcolor="#FFFFFF">
    <td width="258"><div align="right"><strong>退货时间：</strong></div></td>
    <td colspan="3"></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td><div align="right"><strong>发货单流水号：</strong></div></td>
    <td width="213"></td>
    <td width="230"><div align="right"><strong>发货时间：</strong></div></td>
    <td width="230"></td>
  </tr>
  <tr bgcolor="#FFFFFF">
...
<table width="800" border="0"  bordercolor="#F7FFFF">
  <tr>
    <td height="25" colspan="4" align="center" bgcolor="#D9ECFF">收货人信息</td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td width="209"><div align="right"><strong>收货人：</strong></div></td>
    <td width="238"></td>
    <td width="174"><div align="right"><strong>电子邮件：</strong></div></td>
    <td width="151"></td>
  </tr>
  <tr bgcolor="#FFFFFF">
...
<table width="800" border="0"  bordercolor="#F7FFFF">
  ...
  <tr bgcolor="#FFFFFF">
    <td width="180"><div align="center"><strong>商品名称 [ 品牌 ]</strong></div></td>
    <td width="88"><div align="center"><strong>货号</strong></div></td>
    <td width="134"><div align="center"><strong>货品号</strong></div></td>
    <td width="134"><div align="center"><strong>属性</strong></div></td>
    <td width="136"><div align="center"><strong>发货数量</strong></div></td>
  </tr>
</table>
<p>&nbsp;</p>
</body>
