...
<h3>
  <div style="clear:both">
    <table width="1000" border="0" bordercolor="#F7FFFF">
      <tr>
        <td width="829"><a href="index.php?act=main">南鱼商城 管理中心</a> <span id="search_id">- 退货单列表</span></td>
      </tr>
    </table>
  </div>
</h3>
...
<div class="form-div">
  ...
  <tr align="center" bgcolor="#FFFFFF">
    ...
    <td></td>
    <td></td>
    <td><a href="Goods Return Note_research.jsp">查看</a> <a onclick="{if(confirm('您确定要删除吗？')){return true;}return false;}" href="order.php?act=operate&amp;remove_invoice=1&amp;delivery_id=3">移除</a></td>
  ...
  <tr align="center" bgcolor="#FFFFFF">
    ...
    <!-- 分页 -->
<table width="1000" cellspacing="0" id="page-table">
  <tr>
    <td width="800" align="right" nowrap="true" bgcolor="#F0F0F0">
          <!-- $Id: page.htm 14216 2008-03-10 02:27:21Z testyang $ -->
            <div id="turn-page">
        总计  <span id="totalRecords">4</span>个记录分为 <span id="totalPages">1</span>
        页当前第 <span id="pageCurrent">1</span>
        页，每页 
        <input type='text' size='3' id='pageSize' value="4" onkeypress="return listTable.changePageSize(event)" />
        <span id="page-link">
