...
<link href="<%=request.getContextPath()%>/styles/admin/general.css" rel="stylesheet" type="text/css" />
...
.explode {
  background: url(<%=request.getContextPath()%>/images/admin/menu_minus.gif) no-repeat 0px 3px;
  font-weight: bold;
}
.collapse {
  background: url(<%=request.getContextPath()%>/images/admin/menu_plus.gif) no-repeat 0px 3px;
  font-weight: bold;
}
.menu-item {
  background: url(<%=request.getContextPath()%>/images/admin/menu_arrow.gif) no-repeat 0px 3px;
  font-weight: normal;
}
#help-title {
  font-size: 14px;
...
<body>
<div id="tabbar-div">
<p><span style="float:right; padding: 3px 5px;" ><a href="javascript:toggleCollapse();"><img id="toggleImg" src="<%=request.getContextPath()%>/images/admin/menu_minus.gif" width="9" height="9" border="0" alt="闭合" /></a></span>
...
<ul id="menu-ul">
  <li class="explode" key="02_cat_and_goods" name="menu">
    商品管理        <ul>
          <li class="menu-item"><a href="<%=request.getContextPath()%>/AdminProductServlet.do?method=search" target="mainFrame">商品列表</a></li>
          <li class="menu-item"><a href="<%=request.getContextPath()%>/admin/product/produce_list2.jsp" target="mainFrame">添加新商品</a></li>
          <li class="menu-item"><a href="<%=request.getContextPath()%>/AdminProductServlet.do?method=edit" target="mainFrame">商品上下架</a></li>
        </ul>
      </li>
  <li class="explode" key="04_order" name="menu">
    订单管理        <ul>
          <li class="menu-item"><a href="<%=request.getContextPath()%>/orders.do?method=select" target="mainFrame">订单列表</a></li>
         <%-- <li class="menu-item"><a href="<%=request.getContextPath()%>/admin/order/order_inquire.jsp" target="mainFrame">订单查询</a></li>
          <li class="menu-item"><a href="<%=request.getContextPath()%>/admin/order/list_research.jsp" target="mainFrame">订单信息</a></li> --%>
          <%-- <li class="menu-item"><a href="<%=request.getContextPath()%>/admin/order/Goods invoice Note_list.jsp" target="mainFrame">发货单列表</a></li>
          <li class="menu-item"><a href="<%=request.getContextPath()%>/admin/order/Goods Return Note_list.jsp" target="mainFrame">退货单列表</a></li> --%>
        </ul>
      </li>
  <li class="explode" key="07_content" name="menu">
    文章管理        <ul>
          <li class="menu-item"><a href="<%=request.getContextPath()%>/admin/essay/Article.jsp" target="mainFrame">文章列表</a></li>
          <%-- <li class="menu-item"><a href="<%=request.getContextPath()%>/admin/essay/article_sort.jsp" target="mainFrame">文章分类</a></li>
          <li class="menu-item"><a href="<%=request.getContextPath()%>/admin/essay/article_auto.jsp" target="mainFrame">文章自动发布</a></li>
          <li class="menu-item"><a href="<%=request.getContextPath()%>/admin/essay/research.jsp" target="mainFrame">在线调查</a></li> --%>
        </ul>
      </li>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/admin/global.js"></script><script type="text/javascript" src="<%=request.getContextPath()%>/scripts/admin/utils.js"></script><script type="text/javascript" src="<%=request.getContextPath()%>/scripts/admin/transport.js"></script><script language="JavaScript">
<!--
var collapse_all = "闭合";
var expand_all = "展开";
var collapse = true;
...
//  }
  ...
  if (obj.id == 'help-tab')
  {
    ...
    loc = parent.frames['mainFrame'].location.href;
